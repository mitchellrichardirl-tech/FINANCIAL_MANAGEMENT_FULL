...
/**
 * Date-format presets offered in the dropdown. `value: null` means
 * "let the backend auto-detect" (pandas inference + fallbacks).
 * `__CUSTOM__` is a UI sentinel that reveals a free-text input.
 */
